...
//        logIn("a@a.aom", "aaaaaaaa")
    ...
    fun createUser(email:String, pass:String){
        val aaa = auth.createUserWithEmailAndPassword(email, pass)
        aaa.addOnCompleteListener {
            if (it.isSuccessful)
